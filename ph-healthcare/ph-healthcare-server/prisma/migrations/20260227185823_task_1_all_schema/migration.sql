/*
  ...
  - You are about to drop the column `needPassWordChanges` on the `user` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "user" DROP COLUMN "needPassWordChanges",
...
-- RenameIndex
ALTER INDEX "patient_is_deleted_idx" RENAME TO "idx_patient_isDeleted";
